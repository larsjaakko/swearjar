    ...
    render: function() {
        return (
            <div className="category">
                <input type="radio" value="nonne" name="category"/>Nonne
                <input type="radio" value="normal" name="category" defaultChecked="true"/>Normal
                <input type="radio" value="nordlending" name="category"/>Nordlending
            </div>
        );
    }
});
