    ...
    render: function() {
        return (
            <div className="category">
                <input type="radio" value="/sweargen/?category=1" name="category"/>Nonne
                <input type="radio" value="/sweargen/?category=2" name="category" defaultChecked="true"/>Normal
                <input type="radio" value="/sweargen/?category=3" name="category"/>Nordlending
            </div>
        );
    }
});
