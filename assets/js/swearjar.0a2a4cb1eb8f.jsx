    ...
    render: function() {
        return (
            <div className="mainFrame">
                <h1>Banneord.no</h1>
                <TopSite data={this.state.data} clickButton={this.loadSwearWordFromServer}/>
                <BottomSite />
            </div>
        );
    }
    ...
    render: function() {
        return (
            <div className="topSite">
                ...
                <Category />
                <GeneratorButton clickButton={this.clickButton}/>
                <AboutButton />
            </div>
        );
    }
    ...
    render: function() {
        return (
            <div className="generatorButton">
                <input type="button" onClick={this.props.clickButton} value="For faen!" />
            </div>
        );
    }
});
