        ...
        return (
            <div className="category row">
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=1" id="nonne" name="category" onChange={this.handleChange}/><label for="nonne">Nonne</label>
                </div>
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=2" id="normal" name="category" defaultChecked="true" onChange={this.handleChange}/><label for="normal">Normal</label>
                </div>
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=3" id="nordlending" name="category" onChange={this.handleChange}/><label for="nordlending">Nordlending</label>
                </div>
            </div>
        );
    }
