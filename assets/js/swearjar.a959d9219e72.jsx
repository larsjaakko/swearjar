        ...
        return (
            <div className="category row">
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=1" name="category" onChange={this.handleChange}/><label for="sweargen/?category=1">Nonne</label>
                </div>
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=2" name="category" defaultChecked="true"onChange={this.handleChange}/><label for="sweargen/?category=2">Normal</label>
                </div>
                <div className="four columns">
                    <input type="radio" value="sweargen/?category=3" name="category" onChange={this.handleChange}/><label for="sweargen/?category=3">Nordlending</label>
                </div>
            </div>
        );
    }
